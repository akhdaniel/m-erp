...
This script shows how to create, retrieve, and verify persistent sales transactions
...
def test_transaction_persistence():
    ...
    transaction_data = {
        ...
        "title": "Test Sales Transaction",
        "description": "Sample transaction for testing persistence",
        "customer_id": 1001,
        "state": "draft",
    ...
    # Update data
    update_data = {
        "title": "Updated Test Sales Transaction",
        "description": "Updated description for testing persistence",
        "state": "quote_pending_approval",
...
def show_sample_curl_commands():
    ...
    commands = [
        ...
        '     -d \'{"transaction_number": "TXN-2025-002", "title": "API Test Transaction", "customer_id": 1001, "state": "draft", "prepared_by_user_id": 1, "company_id": 1, "subtotal": 100.0, "tax_amount": 8.0, "total_amount": 108.0}\'',
        '',
        ...
        '     -H "Content-Type: application/json" \\',
        '     -d \'{"title": "Updated Transaction", "state": "quote_approved"}\''
    ]
...
if __name__ == "__main__":
    ...
    print("\n📝 Notes:")
    print("   • Ensure the sales service is running on port 8006")
    print("   • The database should be properly configured and accessible")
