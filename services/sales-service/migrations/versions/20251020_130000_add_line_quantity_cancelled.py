...
Revision ID: 20251020_130000
Revises: 20251020_120000
...
revision = '20251020_130000'
down_revision = '20251020_120000'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('sales_order_line_items', sa.Column('quantity_cancelled', sa.DateTime(), nullable=True, index=True))
