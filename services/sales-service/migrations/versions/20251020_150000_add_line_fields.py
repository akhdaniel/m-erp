...
def upgrade() -> None:
    ...
    op.add_column('sales_order_line_items', sa.Column('custom_attributes', sa.JSON(), nullable=True, index=True))
...
def downgrade() -> None:
    ...
    op.drop_column('sales_order_line_items', 'custom_attributes')
