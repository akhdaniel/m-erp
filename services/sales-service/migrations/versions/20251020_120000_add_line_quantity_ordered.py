...
Revision ID: 20251020_120000
Revises: 20251020_110000
...
revision = '20251020_120000'
down_revision = '20251020_110000'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('sales_order_line_items', sa.Column('quantity_ordered', sa.DateTime(), nullable=True, index=True))
