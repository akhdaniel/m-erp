#!/usr/bin/env python3
"""
Script to register the inventory service with the user-auth-service.
"""
...
async def register_inventory_service():
    """Register the inventory service with appropriate scopes."""
    ...
    service_secret = "inventory-service-secret-key-that-is-long-enough"  # This should match the one in docker-compose
...
if __name__ == "__main__":
    asyncio.run(register_inventory_service())