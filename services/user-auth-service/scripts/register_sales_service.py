#!/usr/bin/env python3
"""
Script to register the sales service with the user-auth-service.
"""
...
async def register_sales_service():
    """Register the sales service with appropriate scopes."""
    ...
    service_description = "sales Management Service"
    service_secret = "sales-service-secret-key-that-is-long-enough"  # This should match the one in docker-compose
...
if __name__ == "__main__":
    asyncio.run(register_sales_service())