#!/usr/bin/env python3
"""
Script to register the company-partner service with the user-auth-service.
"""
...
async def register_company_partner_service():
    """Register the company-partner service with appropriate scopes."""
    ...
    service_description = "Company & Partner Management Service"
    service_secret = "company-partner-service-key-1234567890123456"  # This should match the one in docker-compose
...
if __name__ == "__main__":
    asyncio.run(register_company_partner_service())